    ...
    <section className="grid gap-12 lg:grid-cols-12">
      <div className="flex flex-col justify-center lg:col-span-7">
        <p className="text-[10px] uppercase tracking-[0.3em] text-primary">
          Historical Sanctuary • {church.city}, {church.countryCode}
        </p>
        <h1 className="mt-6 font-headline text-5xl font-bold leading-tight text-primary md:text-7xl">{church.name}</h1>
        <p className="mt-8 max-w-xl text-lg leading-relaxed text-on-surface-variant">{church.description}</p>
